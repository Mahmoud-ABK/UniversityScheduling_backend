...
public abstract class EntityMapper {
    ...
    @Autowired public BrancheRepository brancheRepository;
    @Autowired public TPRepository tpRepository;
    @Autowired public PersonneRepository personneRepository;
    @Autowired public EnseignantRepository enseignantRepository;
    @Autowired public SalleRepository salleRepository;
    @Autowired public TDRepository tdRepository;
    @Autowired public EtudiantRepository etudiantRepository;
    @Autowired public SeanceRepository seanceRepository;
    @Autowired public PropositionDeRattrapageRepository propositionDeRattrapageRepository;
    @Autowired public SignalRepository signalRepository;
    ...
    public FrequenceType stringToFrequenceType(String frequence) {
    ...
    public String frequenceTypeToString(FrequenceType frequence) {
        if (frequence == null) {
            return null;
        }
    ...
    public LocalDateTime stringToLocalDateTime(String dateTime) throws CustomException {
    ...
    public SeanceType stringToSeanceType(String type) {
        if (type == null) {
            return null;
        }
    ...
    public String seanceTypeToString(SeanceType type) {
        if (type == null) {
            return null;
        }
        return type.name();
