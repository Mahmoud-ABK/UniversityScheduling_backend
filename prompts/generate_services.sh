...
mkdir -p "$srcprj/service"

# AdminService.java
cat <<'EOF' > "$srcprj/service/AdminService.java"
...
cat <<'EOF' > "$srcprj/service/FeedbackService.java"
package com.scheduling.universityschedule_backend.service;
...
cat <<'EOF' > "$srcprj/service/NotificationService.java"
package com.scheduling.universityschedule_backend.service;
...
cat <<'EOF' > "$srcprj/service/ResourceService.java"
package com.scheduling.universityschedule_backend.service;
...
cat <<'EOF' > "$srcprj/service/ScheduleService.java"
package com.scheduling.universityschedule_backend.service;
...
echo "Service interfaces have been generated under $srcprj/service"